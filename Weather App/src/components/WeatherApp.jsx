...
const WeatherApp = () => {
  ...
  const API_KEY = "03ebefc06737ecf3c744167c7a78092b";
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-500 to-blue-700 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="mb-8">
              <div className="flex">
                <input
                  ...
                  className="flex-grow px-4 py-2 border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <button
                  type="submit"
                  disabled={loading}
            ...
            {/* For error when fetching data from api */}
            {error && (
            ...
            {weatherData && (
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  ...
                  <div className="bg-white p-3 rounded-lg shadow-sm">
                    <div className="text-gray-500 text-sm">
                      Wind Speed {weatherData.weather[0].speed}
                    </div>
                    <div className="font-semibold">1.32m/s</div>
                  </div>
                  <div className="bg-white p-3 rounded-lg shadow-sm">
